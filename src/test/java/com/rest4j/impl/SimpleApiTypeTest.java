...
public class SimpleApiTypeTest {
	...
	public void testCheck_boolean() throws Exception {
		SimpleApiType simpleApiType = new BooleanApiTypeImpl(null);
	...
	public void testCheck_number() throws Exception {
		SimpleApiType simpleApiType = new NumberApiTypeImpl(null);
	...
	public void testCheck_string() throws Exception {
		SimpleApiType simpleApiType = new StringApiTypeImpl(null, null);
	...
	public void testCheck_enum() throws Exception {
		SimpleApiType simpleApiType =new StringApiTypeImpl(null, new String[]{"friend", "ate"});
		assertTrue(simpleApiType.check(String.class));
	...
	public void testCheck_enum_notfound() throws Exception {
		SimpleApiType simpleApiType = new StringApiTypeImpl(null, new String[]{"friend", "ate", "mated", "WRONG"});
